...
export default function Signup() {
  ...
  const handleSignup = async (e) => {
    ...
    try {
      ...
      toast.error(error.response?.data?.message || "Signup failed / नोंदणी अयशस्वी", {
        position: "top-center",
        autoClose: 5000,
      });
    } finally {
  ...
  const handleVerifyOTP = async (e) => {
    ...
    try {
      ...
      toast.success("Signup successful! You can now log in. / नोंदणी यशस्वी! आता तुम्ही लॉगिन करू शकता.", {
        position: "top-center",
        autoClose: 2000,
        ...
        {step === 1 && (
          <>
            <h2 className="text-xl font-bold mb-6 text-center text-gray-700">
              Create Your Account / खाते तयार करा
            </h2>
            <form onSubmit={handleSignup} className="space-y-4">
              ...
              <div className="bg-blue-50 p-3 rounded-lg">
                <p className="text-sm font-medium mb-2">Password Requirements / पासवर्ड आवश्यकता:</p>
        ...
        {step === 2 && (
          <>
            ...
            <p className="text-gray-600 text-center mb-6">
              ...
              आम्ही तुमच्या ईमेलवर OTP पाठवला आहे. कृपया ते खाली प्रविष्ट करा.
            </p>
